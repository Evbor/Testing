...
# Setting up placeholder objects to feed data to
...
# Setting up Dataset objects to store data using unfed placeholder objects
...
# Setting up Training and Testing Dataset objects from previous Dataset objects
